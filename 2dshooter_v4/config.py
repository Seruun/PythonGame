...
BACKGROUND_IMG = "background_komprimiert.png"
...
PLAYER_WALKING_SOUND = "walking_stone.wav"
...
ENEMY_SHOOT_SPEED = 50    #in milliseconds
ENEMY_BULLET_DAMAGE = 20
ENEMY_BULLET_SHOT_SOUND = "m4silencer.wav"